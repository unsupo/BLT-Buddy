  ...
  _createClass(Filter, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        className: "slds-assistive-text"
      }, assistiveText.editFilter), this.props.property ? React.createElement("span", {
        className: "slds-show slds-text-body_small"
      }, this.props.property) : null, React.createElement("span", {
        className: "slds-show"
      }, this.props.predicate))) : React.createElement("button", {
        "aria-describedby": this.props.isError ? "".concat(this.getId(), "-error") : undefined,
        className: "slds-button_reset slds-grow slds-has-blur-focus",
        disabled: true,
        type: "button"
        ...
        className: "slds-show slds-text-body_small"
      }, this.props.property), React.createElement("span", {
        className: "slds-show"
